...
// console.log(findCodePosition("Learn to code with JavaScript")); // Output: 10
...
// console.log(hasJavaScript("I love coding in JavaScript!")); // Output: true
...
// console.log(extractFirstTenChars("Hello, JavaScript world!")); // Output: Hello, Java
